...
namespace Jardin
{
    public partial class Form1 : Form
    {
        ...
        private void porApellidoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FrmBuscarPorApellido frmBuscarPorApellido = new FrmBuscarPorApellido(listaAlumnosEnSala);
